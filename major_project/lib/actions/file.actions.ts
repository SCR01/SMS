...
export const uploadFile = async ({
  ...
  try {
    ...
    const fileDocument = {
      ...
      accountId,
      users: [],
      bucketField: bucketFile.$id, // Changed from bucketFileId to bucketField
    };
...
export const deleteFile = async ({
  ...
  if (!bucketField) throw new Error("Missing required parameter: bucketField");
